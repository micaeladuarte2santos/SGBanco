...
%>
	...
	<div class="contenido">
		...
		<div class="parteDer">
			<h2>Cantidad de Préstamos según Rango de Monto</h2>
			<form method="get" action="servletInformePrestamos">
			...
			<h3>Resultado</h3>
		    <img src="servletInformePrestamos?fechaInicio=<%= request.getParameter("fechaInicio") %>&fechaFin=<%= request.getParameter("fechaFin") %>" alt="Gráfico de Préstamos">
